 ...
 *   <li>{@code startUhrzeit} / {@code endeUhrzeit} – 15-minute interval in UTC.</li>
...
public class DetectionDTO {
    ...
    public Instant getStartUhrzeit() { return startUhrzeit; }
    public void setStartUhrzeit(Instant startUhrzeit) { this.startUhrzeit = startUhrzeit; }

    public Instant getEndeUhrzeit() { return endeUhrzeit; }
    public void setEndeUhrzeit(Instant endeUhrzeit) { this.endeUhrzeit = endeUhrzeit; }

    public Integer getPkw() { return pkw; }
    public void setPkw(Integer pkw) { this.pkw = pkw; }

    public Integer getLkw() { return lkw; }
    public void setLkw(Integer lkw) { this.lkw = lkw; }

    public Integer getLastzuege() { return lastzuege; }
    public void setLastzuege(Integer lastzuege) { this.lastzuege = lastzuege; }

    public Integer getBusse() { return busse; }
    public void setBusse(Integer busse) { this.busse = busse; }

    public Integer getKraftraeder() { return kraftraeder; }
    public void setKraftraeder(Integer kraftraeder) { this.kraftraeder = kraftraeder; }

    public Integer getFahrradfahrer() { return fahrradfahrer; }
    public void setFahrradfahrer(Integer fahrradfahrer) { this.fahrradfahrer = fahrradfahrer; }

    public Integer getFussgaenger() { return fussgaenger; }
    public void setFussgaenger(Integer fussgaenger) { this.fussgaenger = fussgaenger; }

    public Integer getVon() { return von; }
    public void setVon(Integer von) { this.von = von; }

    public Integer getNach() { return nach; }
    public void setNach(Integer nach) { this.nach = nach; }
